...
/**
 * Servlet implementation class proinout_tuihuan
 */
@WebServlet("/proinout_tuihuan")
public class proinout_tuihuan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public proinout_tuihuan() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				String strSql1=" insert into tbinout_tuihuan (opttype,proid,pronum,proname,protype,proimgurl,prooldnum,proaddnum,unitname,ctime) values (?,?,?,?,?,?,?,?,?,?)";
				...
				String strSql2="update tbproduct_tuihuan set procount=(SELECT SUM(opttype*proaddnum) from tbinout where pronum=?) where pronum=?";		
				...
				response.setHeader("Refresh", "3;URL="+request.getContextPath()+"/admin/proinout_tuihuan.jsp?t="+t);	
	}
