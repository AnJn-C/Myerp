...
/**
 * Servlet implementation class salesright
 */
@WebServlet("/salesright")
public class salesright extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String strSqlpager=" select  * from tbsalesshoppingcar where sessionid=? "; 
		...
		request.getRequestDispatcher("/admin/salesright.jsp").forward(request, response);
	}
