...
/**
 * Servlet implementation class pro_tuihuan
 */
@WebServlet("/pro_tuihuan")
public class pro_tuihuan extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				response.setHeader("Refresh", "3;URL="+request.getContextPath()+"/admin/pro_tuihuan.jsp?t="+t);	
	}
