...
%>
<div class="path">当前位置:/夜鹰进销存系统/系统管理/日志查询             <span class="rightbox"><input type="text" id="tbkey"/><input type="button" id="btnsearch" value="查询"/></span></div>
    ...
    <script type="text/javascript">
    	$("td.typename").each(function(index,item){
    		...
    		switch(typeid)
    		{
    			...
    			case "2":$(item).text("操作日志"); $(item).parents("tr").css({"background-color":"red","color":"#fff"});break;
    			case "3":$(item).text("异常日志");break;
    		}
    	});
