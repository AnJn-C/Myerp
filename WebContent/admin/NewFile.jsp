...
<body class="">
    <form name="form1" method="post" action="/loginpost/" id="form1">
			{% csrf_token %}
			<div id="logincontainer">
				<h3 class="title"><img style="position: relative; top: 6px;" src="../img/kokof.png" width="22px"; height="22px";></img>&nbsp;小程序后台管理系统v1.1</h3>
				<div class="loginform">
					<p id="msg">{{msg}}</p>
					<div class="one1">
    ...
    <script src="/static/myadmin/js/jquery-1.11.0.js"></script>
    <script>
