...
<html>
	...
	<body>
		...
		<form name="form1" method="post" action="top.aspx" id="form1">
			<div class="linear">
				<div class="ziti1">
					<img style="position: relative; top: 4px; right:5px" src="img/xiaoxun1.png" width="30px"; height="30px";/>电器仓库进销存管理系统v1.1
				</div>
			</div>
			<ul class="nav">
			...
			<div class="timeanduser">
				...
				<p id="currentuser">当前用户: 【admin】<a href="Login.html" target="_top" id="logout" title="退出系统"><img src="img/logout5.png"></a> </p>
			</div>
		</form>
